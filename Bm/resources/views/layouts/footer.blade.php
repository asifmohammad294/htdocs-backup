            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                    ...
                    <div class="footer-widget">
                        <a href="#"><img src="http://localhost/bm/public/images/logo.png" alt="" class="mb20"></a>
                ...
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="footer-widget">
                        ...
                        <p>A-30/22B, 2nd Floor, Main Moujpur Road, Delhi-110053
                            <br> </p>
                        <p class="mb0 text-default">+0-800-1234-123</p>
                        <p class="mb0 text-default">info@devinematchmakers.com</p>
                    </div>
                </div>
                <!-- /.footer-widget -->
                <!-- footer-widget -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-right">
                    <p>© 2018 oakbells. All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </div>
