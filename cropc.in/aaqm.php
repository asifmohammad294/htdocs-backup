...
<section class="page-breadcumb-header">
  <div class="container">
    <div class="row">
      ...
      <div class="breadcumb-wrapper"> <a href="#">Home</a> <span>Weather </span> </div>
    </div>
  </div>
</section>
<!-- PAGE HEADER END -->
...
<?php 
$page = file_get_contents("https://app.cpcbccr.com/ccr/#/caaqm-dashboard-all/caaqm-landing");
echo $page;
?>
<br>
<br>
