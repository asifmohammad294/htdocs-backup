...
<section class="page-breadcumb-header">
  <div class="container">
    <div class="row">
      ...
      <div class="breadcumb-wrapper"> <a href="#">Home</a> <span>Mission </span> </div>
    </div>
  </div>
</section>
<!-- PAGE HEADER END -->
                ...
                <div class="row"> 
                  ...
                  <div class="page-contents col-md-12 col-sm-12 col-xs-12">
                    <div class="inner-section">
                      <div class="#">
                        <h2 class="content-inner-title">Climate Resilient Observing Systems Promotion Council (CROPC)<span class="bold-text"></span></h2>
                            <p>The mission is to provide people oriented quality services in Climate Change Risk
Management and related fields with special emphasis on impact based dissemination to last
mile and enhance Council’s capability in the field of development and natural disaster
mitigation , prevention and response through science, innovation, partnership and
