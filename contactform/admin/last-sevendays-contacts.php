...
<head>
  <title>Contact form Admin- Last seven days Contacts</title>
...
$sql = "SELECT FullName,EmailId,PhoneNumber,City,PostingDate,id,Is_Read from tblcontactdata where date(PostingDate)>= DATE(NOW()) - INTERVAL 7 DAY";
